...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="connexion_admin.php">Gestion des &eacute;tudiants</a>
        </div>
...
if (isset($_POST['user']) && isset($_POST['password'])) {
    if($c->verif_connect_admin($_POST['user'],$_POST['password'])){
        ?>
        <style>
            div.taille {
                width:500px;
...
if (isset($_POST['userinscri']) && isset($_POST['passwordinscri'])&& isset($_POST['confirm-password'])) {
    if($_POST['userinscri']=="" || $_POST['passwordinscri']=="" || $_POST['confirm-password']==""){
    ...
    else if($c->verif_exist_admin($_POST['userinscri'])){
        ?>
        <style>
            div.taille {
                width:500px;
        ...
        <?php
        $file = './img/default_user/admin_default';
        $newfile = './img/users/admin/'.$_POST['userinscri'];
