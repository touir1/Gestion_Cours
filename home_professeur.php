...
if(isset($_SESSION['connected']) && $_SESSION['connected']=="1") {
    $info=$c->get_all_info_professeur($_SESSION['user']);
    $connected = $_SESSION['user'];
    $_SESSION['image_path']="./img/users/professeur/".$connected."/";
    ...
    if (isset($_POST['confirm-password']) && isset($_POST['passwordinscri'])) {
        if($c->verif_connect_professeur($connected,$_POST['old-password'])){
            if($_POST['confirm-password']!="" && $_POST['passwordinscri']!=""){
                if($_POST['passwordinscri']==$_POST['confirm-password'] ){
                    $c->modifier_auth_professeur($connected,$_POST['passwordinscri']);
                    ?>
                    <style>
                        div.taille {
                            width:500px;
        ...
        <div class="col-md-3">
            <div class="profile-sidebar">
                ...
                <div class="profile-userpic">
                    <img src="<?php
                    if(file_exists("./img/users/professeur/".$connected."/pic.png")) {

                        $c->convert_image("./img/users/professeur/".$connected."/pic.png",500,500);
                        echo "./img/users/professeur/" . $connected . "/pic.png";
                    }
                    else{
                        echo "./img/users/professeur/" . $connected . "/default.png";
                    }
                ...
                <div class="profile-usertitle">
                    ...
                    <div class="profile-usertitle-job">
                        Professeur Institut Sup&eacute;rieur de Gestion de Tunis
                    </div>
                </div>
                        ...
                        for($i=0;$i<$c->get_number_article();$i++){
                            ...
                            <tr>
								<td>
									...
									<form action="home_professeur.php" method="post">
